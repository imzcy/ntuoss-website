(function($, zcy) {
    ...
    $('<style>' + 
    '.zcy-gallery {margin: 8px; line-height: 0;position: relative;border: 2px solid #ccc;overflow: hidden;box-shadow: inset 1px 1px 4px #ccc;height: 176px;white-space: nowrap;padding: 0px;cursor: move !important;-webkit-user-select: none;-khtml-user-select: none;-moz-user-select: none;-o-user-select: none;user-select: none;}' + 
    '.zcy-gallery-leftmost{display:none;height: 100%; width: 48px; float: left; z-index: 5; position: relative; background: -moz-linear-gradient(left,  rgba(204,204,204,0.65) 0%, rgba(228,228,228,0.5) 70%, rgba(238,238,238,0) 100%); /* FF3.6+ */background: -webkit-gradient(linear, left top, right top, color-stop(0%,rgba(204,204,204,0.65)), color-stop(70%,rgba(228,228,228,0.5)), color-stop(100%,rgba(238,238,238,0))); /* Chrome,Safari4+ */background: -webkit-linear-gradient(left,  rgba(204,204,204,0.65) 0%,rgba(228,228,228,0.5) 70%,rgba(238,238,238,0) 100%); /* Chrome10+,Safari5.1+ */background: -o-linear-gradient(left,  rgba(204,204,204,0.65) 0%,rgba(228,228,228,0.5) 70%,rgba(238,238,238,0) 100%); /* Opera 11.10+ */background: -ms-linear-gradient(left,  rgba(204,204,204,0.65) 0%,rgba(228,228,228,0.5) 70%,rgba(238,238,238,0) 100%); /* IE10+ */background: linear-gradient(to right,  rgba(204,204,204,0.65) 0%,rgba(228,228,228,0.5) 70%,rgba(238,238,238,0) 100%); /* W3C */filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#a6cccccc", endColorstr="#00eeeeee",GradientType=1 ); /* IE6-9 */}' +
    '.zcy-gallery-rightmost{display:none;height: 100%; width: 48px; float: right; z-index: 5; position: relative; background: -moz-linear-gradient(left,  rgba(238,238,238,0) 0%, rgba(228,228,228,0.5) 30%, rgba(204,204,204,0.65) 100%); /* FF3.6+ */background: -webkit-gradient(linear, left top, right top, color-stop(0%,rgba(238,238,238,0)), color-stop(30%,rgba(228,228,228,0.5)), color-stop(100%,rgba(204,204,204,0.65))); /* Chrome,Safari4+ */background: -webkit-linear-gradient(left,  rgba(238,238,238,0) 0%,rgba(228,228,228,0.5) 30%,rgba(204,204,204,0.65) 100%); /* Chrome10+,Safari5.1+ */background: -o-linear-gradient(left,  rgba(238,238,238,0) 0%,rgba(228,228,228,0.5) 30%,rgba(204,204,204,0.65) 100%); /* Opera 11.10+ */background: -ms-linear-gradient(left,  rgba(238,238,238,0) 0%,rgba(228,228,228,0.5) 30%,rgba(204,204,204,0.65) 100%); /* IE10+ */background: linear-gradient(to right,  rgba(238,238,238,0) 0%,rgba(228,228,228,0.5) 30%,rgba(204,204,204,0.65) 100%); /* W3C */filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#00eeeeee", endColorstr="#a6cccccc",GradientType=1 ); /* IE6-9 */"}' + 
    '</style>').appendTo("head");
